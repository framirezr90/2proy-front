...
<body>
    ...
    <main>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="p-3 text-center">
                                    <h2>Quienes Somos</h2>
                                    <div>
                                        <p>Bienvenido a Energy and Water SpA, una empresa líder en la instalación y
                                        ...
                                        <p>Te invitamos a contactarnos para discutir tus necesidades y ofrecerte un
                                            ...
                                            tu calidad de vida y aportar valor a tu propiedad. En <b>Energy and Water SpA</b>,
                            ...
                            <div class="col-6">
                                <div class="p-3 text-center">
                                    <img src="img/61.jpg" class="img-fluid" alt="Imagen 2">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="service-item">
                            ...
                            <p class="p-service">El mantenimiento del aire acondicionado incluye limpiar filtros y
                                bobinas, revisar
                                refrigerante, y asegurarse del correcto funcionamiento del termostato.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="service-item">
                            ...
                            <p class="p-service">El mantenimiento de la sala de calderas incluye inspeccionar y limpiar
                                quemadores,
                                revisar válvulas y chequear niveles de agua y presión.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="service-item">
                            ...
                            <p class="p-service">El mantenimiento del grupo electrógeno incluye revisar aceite y
                                filtros, chequear
                                baterías, inspeccionar conexiones y probar el sistema regularmente.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="service-item">
                            ...
                            <p class="p-service">El mantenimiento de la sala de bombas incluye revisar sellos, lubricar
                                partes móviles,
                                inspeccionar conexiones y comprobar el funcionamiento general.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="gallery-item">
                            <img src="img/54.jpg" alt="Imagen 1" class="img-gallery">
                    ...
                    <div class="col-md-4">
                        <div class="gallery-item">
                            <img src="img/68.jpg" alt="Imagen 2" class="img-gallery">
                            <div class="gallery-overlay">
                                <i class="fas fa-search"></i>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="gallery-item">
                            <img src="img/62.jpg" alt="Imagen 4" class="img-gallery">
                            <div class="gallery-overlay">
                                <i class="fas fa-search"></i>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="gallery-item">
                            <img src="img/66.jpg" alt="Imagen 5" class="img-gallery">
                            <div class="gallery-overlay">
                                <i class="fas fa-search"></i>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="gallery-item">
                            <img src="img/img8.jpg" alt="Imagen 6" class="img-gallery">
                            <div class="gallery-overlay">
                                <i class="fas fa-search"></i>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="service-item">
                            ...
                            <div>
                                ...
                                <p class="p-history"> Abello, fundador de Energy and Water SpA, es un líder colaborativo
                                    en los sectores de climatización y electricidad, practicando un liderazgo
                                    democrático que valora las opiniones del equipo. Sus habilidades clave incluyen
                                    la resolución de problemas, comunicación efectiva, pensamiento crítico, y gestión.
                                    Ha logrado acreditaciones para centros de salud en San Joaquín, reparaciones en el
                                    museo de la Universidad de los Andes, y mantenimiento de grupos electrógenos
                                    críticos.
                                    Adaptó su liderazgo a las nuevas normativas sanitarias durante la pandemia
                                    implementando
                                    protocolos de prevención y capacitación. Su objetivo es mantener la continuidad
                                    operacional de
                                    los clientes y mejorar los procesos de mantenimiento y calidad.
        ...
        <section id="team">
            <div class="container">
                <h2 class="text-center my-5">Nuestro Equipo</h2>
                <div id="teamSection" class="row hidden">
                    <div class="col-md-3 col-sm-6">
                        <div class="team-member">
                            <div class="circle">
                                <img src="img/vector.jpg" alt="Miembro del Equipo 1">
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="team-member">
                            <div class="circle">
                                <img src="img/vector.jpg" alt="Miembro del Equipo 2">
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="team-member">
                            <div class="circle">
                                <img src="img/vector.jpg" alt="Miembro del Equipo 3">
                            </div>
                            <h4> Mathias Avila </h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="team-member">
                            <div class="circle">
                                <img src="img/vector.jpg" alt="Miembro del Equipo 4">
                            </div>
                    ...
                    <div class="container-form">
                        ...
                        <form id="contact-form">
                            ...
                            <select class="form-select" name="servicio" required>
                                ...
                                <option value="Mantenimiento aire acondicionado">Mantenimiento aire acondicionado
                                </option>
                                <option value="Mantenimiento sala de calderas">Mantenimiento sala de calderas</option>
                                <option value="Mantenimiento grupo electrogenos">Mantenimiento grupo electrogenos
                                </option>
        ...
        <section id="faq" class="section">
            <div>
                ...
                <div class="preguntas">
                    ...
                    <div class="contenedor-pregunta">
                        <p class="pregunta">¿Necesitas visita técnica? <img src="./img/suma.svg" alt="Abrir Respuesta">
                        </p>
